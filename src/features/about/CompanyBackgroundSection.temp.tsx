      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            initial={{ opacity: 0, x: 20 }}
            animate={
              isTimelineInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 20 }
            }
            transition={{ duration: 0.8 }}
          ...
          >
            ...
            <Timeline>
              ...
              <motion.div
                ...
                animate={
                  isTimelineInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
                }
              ...
              >
                <TimelineItem>
                  ...
                  <TimelineContent>
                    <p>
                      Irazu Technology was born to meet the growing demand for
                      HFC and FTTH network designs.
                    </p>
                  </TimelineContent>
                </TimelineItem>
              </motion.div>
              ...
              >
                <TimelineItem>
                  ...
                  <TimelineContent>
                    <p>
                      Began collaborations with industry leaders such as
                      Charter, Comcast, and SEFNCO.
                    </p>
                  </TimelineContent>
                </TimelineItem>
              </motion.div>
              ...
              >
                <TimelineItem>
                  ...
                  <TimelineContent>
                    <p>
                      Grew to a team of 10+ engineers and specialists focused on
                      excellence.
                    </p>
                  </TimelineContent>
                </TimelineItem>
              ...
              >
                <TimelineItem>
                  ...
                  <TimelineContent>
                    <p>
                      Established as a trusted partner with 40+ years of
                      combined experience.
                    </p>
                  </TimelineContent>
                </TimelineItem>
